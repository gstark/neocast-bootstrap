...
function isInDOMSubtrees(element, subtreeRoots = []) {
  return (
    subtreeRoots && subtreeRoots.length && subtreeRoots.filter(subTreeRoot => isInDOMSubtree(element, subTreeRoot))[0]
  )
}

export class TooltipPopoverWrapper extends React.Component {
  constructor(props) {
    super(props)
